        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-3 py-2 text-sm font-medium leading-4 text-stone-300 transition ease-in-out duration-150 hover:bg-white/10 hover:text-white focus:outline-none">
